 ...
 */
@Grab('org.sonatype.nexus:nexus-rest-client:3.41.1-01')
@Grab('org.sonatype.nexus:nexus-rest-jackson2:3.41.1-01')
@Grab('org.sonatype.nexus:nexus-script:3.41.1-01')
@Grab('org.jboss.spec.javax.servlet:jboss-servlet-api_3.1_spec:1.0.2.Final')
@Grab('com.fasterxml.jackson.core:jackson-core:2.13.4')
@Grab('com.fasterxml.jackson.core:jackson-databind:2.13.4')
@Grab('com.fasterxml.jackson.core:jackson-annotations:2.13.4')
...
@Grab('org.jboss.logging:jboss-logging-processor:2.2.1.Final')
@Grab('com.sun.xml.bind:jaxb-impl:4.0.0')
...
groovy.cli.commons.CliBuilder cli = new groovy.cli.commons.CliBuilder(
